...
export interface AcceptedTermsResponse {
    ...
    accepted: string;
    terms_name: string;
    extended_terms: ExtendedTerms[] | null;
    toll_authority_name?: string;
}
...
export class TermsService {
    ...
    constructor(
        ...
        this.debugService.registerNewConsoleCommand('createTestPBM', () => {
        ...
        this.debugService.registerNewConsoleCommand('createTestFleetPBM', () => {
