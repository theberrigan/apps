...
import {Pagination} from './history/pagination/pagination.component';
import {PaymentMethodWallet} from '../../services/stripe.service';
import {PaymentMethodCard} from '../../services/payment.service';
...
export interface SpecificInvoiceSubscription {
    id: string;
    payment_amount: number;
    currency: string;
    max_lp: number;
...
export interface SpecificInvoiceHistory {
    ...
    subscription: SpecificInvoiceSubscription;
}
