...
@Component({
    ...
    host: {
        class: 'dashboard',
        // '[class.dashboard_nav-minimized]': 'nav && nav.isMinimized',
        // '[class.dashboard_nav-active]': 'nav && nav.isMobileActive'
    }
})
export class DashboardComponent implements OnInit, OnDestroy {
    ...
    public readonly appReleaseDate : string = APP_RELEASE_DATE;
