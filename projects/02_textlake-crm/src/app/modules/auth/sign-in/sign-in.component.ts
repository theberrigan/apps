...
export class SignInComponent implements OnInit {
    ...
    // "Забыл пароль" -> Ввести емейл -> Ввести код и новый пароль
    // PasswordResetRequiredException -> Ввести код и новый пароль (второй лейаут из "Забыл пароль")
    // + newPasswordRequired -> Ввести новый пароль
}
