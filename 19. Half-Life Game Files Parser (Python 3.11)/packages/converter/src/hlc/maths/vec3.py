...
from .consts import VEC3_ORIGIN
...
def scaleVec3 (v : Vec3 | Vec4, scalar : float | int, out : Vec3 | Vec4) -> None:
    assert len(v) >= 3
...
def subVec3 (v1 : Vec3 | Vec4, v2 : Vec3 | Vec4, out : Vec3 | Vec4) -> None:
...
def divVec3 (v : Vec3 | Vec4, scalar : float | int, out : Vec3 | Vec4) -> None:
    assert len(v) >= 3
...
def averageVec3 (v1 : Vec3 | Vec4, v2 : Vec3 | Vec4, out : Vec3 | Vec4) -> None:
    assert len(v1) >= 3 and len(v2) >= 3 and len(out) >= 3
