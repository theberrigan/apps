<?php
/*
Template Name: FasTrak Landing
*/

add_action('wp_enqueue_scripts', 'enqueueFastrakAssets');

$faqData = fetchFAQ($TNP_CALIFORNIA_BRAND);
    ...
    <div class="section-main__bg">
        <div class="section-main__content">
            <div class="section-main__text">
                <h1 class="section-main__text-header">Paying FasTrak tolls just got easier</h1>
                <div class="section-main__text-description">
                    In three quick and easy steps, you will be on your way to using FasTrak toll roads, without requiring a toll tag. With free registration until February 15th, 2022
                </div>
            </div>
            <div class="section-main__form">
                <div class="section-main__form-content">
                    ...
                    <div class="section-main__form-inputs">
                        ...
                        <?php require(dirname(__FILE__) . '/fastrak_phone_form.php'); ?>
                    </div>
                </div>
            </div>
        </div>
...
<section class="section-points">
    ...
    <div class="section-points__item">
        ...
        <div class="section-points__item-text">
            ...
            <div class="section-points__item-description">
                Simply drive the FasTrak toll roads, approve daily charges via SMS/Text, and pay using your payment choice (and there a lots to choose from)
            </div>
        </div>
    </div>
</section>
...
<section class="section-steps" id="how_it_works">
    ...
    <div class="section-subheader">Once you register your vehicles license plate, your tolls can be charged to either Apple Pay, Google Pay, Credit or Debit card, or PayPal/Venmo. If you can text on your phone, you can pay on your phone! Registering from your phone is simple, takes only a few minutes and until February 15th, 2022, it’s free to join</div>
    <div class="section-steps__items">
        <div class="section-steps__card">
            <img class="section-steps__card-image" src="<?php echo (get_template_directory_uri() . '/assets/images/fastrak/step_1.svg') ?>" alt="Step 1">
        ...
        <div class="section-steps__card">
            <img class="section-steps__card-image" src="<?php echo (get_template_directory_uri() . '/assets/images/fastrak/step_2.svg') ?>" alt="Step 2">
            <div class="section-steps__card-header">Drive</div>
            <div class="section-steps__card-description">It’s time to hit the road! After you’ve completed your registration, simple drive any FasTrak toll road and receive a text notification to approve your daily transaction</div>
        </div>
        <div class="section-steps__arrow"></div>
        <div class="section-steps__card">
            <img class="section-steps__card-image" src="<?php echo (get_template_directory_uri() . '/assets/images/fastrak/step_3.svg') ?>" alt="Step 3">
...
<section class="section-testimonials" id="testimonials">
    ...
    <div class="section-testimonials__items">
        <div class="section-testimonials__item">
            <div class="section-testimonials__item-content">
                <div class="section-testimonials__item-text">
                    I was traveling in Miami and didn't have a FasTrak tag. I wanted to avoid getting a paper invoice which is a hassle to deal with,  so I joined  tapNpay in less than 2 minutes. Great payment tool.
                </div>
        ...
        <div class="section-testimonials__item">
            <div class="section-testimonials__item-content">
                <div class="section-testimonials__item-text">
                    I was visiting from Dallas where I use tapNpay to pay my NTTA tolls. What a pleasure to see I could use it in Florida on the FasTrak roads as well.  
                </div>
                <div class="section-testimonials__item-sign">
    ...
    <div class="section-feedback__content">
        ...
        <fieldset class="section-feedback__fieldset">            
            <form method="POST" action="/" class="section-feedback__form">
                ...
                <input type="hidden" name="brand" value="FASTRAK">
...
<section class="section-getting-started" id="get_started">
    <div class="section-getting-started__overlay">
        <h2 class="section-header">Why use tapNpay</h2>
        <div class="section-getting-started__text">
            <p>We’ve created a new mobile payment option to make FasTrak toll payments more convenient and accessible for pay-by-mail customers. Register your license plate number through SMS/Text, answer a few questions, drive the roads, approve daily charges (via text), and pay by your favorite method (Apple Pay, Google Pay, Credit Card, Debit Card, PayPal or Venmo). The service normally costs $5.00 one-time registration fee to join, but we’re waiving that fee until February 15th, 2022, so make sure to take advantage of this special offer right away.</p>
            <p>All you need to get started is a phone that can text, and any of the payment methods we offer. Then voila, your ready to drive the FasTrak roads right away!</p>     
        </div>
...
<footer class="footer">
    <div class="footer__content">
        ...
        <div class="footer__item footer__item_right">
            <a href="<?= getFastrakPrivacyPolicyURL(); ?>" class="footer__link">Privacy Policy</a>
        </div>        
    </div>
</footer>
