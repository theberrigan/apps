...
**👇 Следующие несколько проектов являются частями этого продукта.**  
...
**👇 Сейчас ищу работу. Ниже несколько тестовых заданий, которые я делал для разных компаний.**
...
## 🎯 [Тестовое задание для Яндекса](projects/23_yandex-test-landing) <sup><sub>тестовое</sub></sup>

📝 Сверстать лендинг по готовому макету Figma, добавить анимации по вкусу, оживить бегущую строку и карусель. Он должен быть адаптивным для всех устройств. Использовать только чистые JS, HTML и CSS без библиотек и фреймворков.  
⚙️ Чистый **JS**, **HTML**, **CSS**, **Serve**.  
👀 **[Демо](https://theberrigan.github.io/demos/yandex-test-landing/)** 

![](projects/23_yandex-test-landing/misc/images/preview.webp)



<br>

## 🎯 [Тестовый каталог фильмов](projects/24_test_movie_catalog) <sup><sub>тестовое</sub></sup>

📝 Разработать каталог фильмов с поиском. При клике на фильм должна появляться его карточка.   
...
⚙️ Сервер: чистый **JS**, **Node.js**, **Express** и **SQLite**. Клиент: **Angular 20**.  
👀 Внутри есть README с инструкцией, как собрать и запустить проект. 

![](projects/24_test_movie_catalog/misc/images/preview.webp)
